...
class Viewer extends Component {
  ...
  loadConfig() {
    ...
    r.style.setProperty('--checkbox-color', window.configData.backgroundColors.checkboxColor)
    r.style.setProperty('--checkbox--checked-color', window.configData.backgroundColors.checkboxCheckedColor)
    r.style.setProperty('--concept-entry-block-color', window.configData.backgroundColors.conceptEntryBlockColor)
    r.style.setProperty('--header-color', window.configData.backgroundColors.headerColor)
    r.style.setProperty('--metadata__button-color', window.configData.backgroundColors.metadataButtonColor)
    r.style.setProperty('--metadata-term__blink__active-color', window.configData.backgroundColors.metadataTermBlinkActiveColor)
    r.style.setProperty('--popup-color', window.configData.backgroundColors.popupColor)
    r.style.setProperty('--term-block-color', window.configData.backgroundColors.termBlockColor)
    r.style.setProperty('--term-block__lang-button-color', window.configData.backgroundColors.termBlockLangButtonColor)
   
    r.style.setProperty("--font-family", window.configData.font.fontFamily)
